...
static ServletContext sc;
    ...
    public int addStudent(StudentRegistration student){
    	...
    	registrationStmt=registrationConn.prepareStatement("INSERT INTO tbl_student(course_id, category_id," +
    			...
    			"parent_guardian_last_name,sex,age,birth_date,address_line_1,address_line_2,country_id" +
    			"" +
    	...
    	registrationStmt.setInt(10,student.getAge());
    	registrationStmt.setDate(11,student.getDateOfBirth());
    	registrationStmt.setString(12,student.getAddressLineOne());
    	registrationStmt.setString(13,student.getAddressLineTwo());
    	registrationStmt.setInt(14,student.getCountryId());
    	registrationStmt.setInt(15,student.getCityId());	
    	registrationStmt.setString(16,student.getPostcode());
    	registrationStmt.setString(17,student.getEmail());
    	registrationStmt.setString(18,student.getContact());
    	registrationStmt.setString(19,student.getPassportNo());
    ...
    public ArrayList<StudentRegistration> getStudentList(){
    	try{
        	...
        	while(registrationRs.next()){
        		...
        		student.setAge(registrationRs.getInt("age"));
    ...
    public void updateStudentProfile(StudentRegistration student){
    	  try{
        	...
        	registrationStmt.setInt(8,student.getAge());
        	registrationStmt.setDate(9,student.getDateOfBirth());
        	registrationStmt.setString(10,student.getAddressLineOne());
        	registrationStmt.setString(11,student.getAddressLineTwo());
        	registrationStmt.setInt(12,student.getCountryId());
        	registrationStmt.setInt(13,student.getCityId());
        	registrationStmt.setString(14,student.getPostcode());
        	registrationStmt.setString(15,student.getEmail());
        	registrationStmt.setString(16,student.getContact());
        	registrationStmt.setString(17,student.getPassportNo());
        	registrationStmt.setString(18,student.getImagePath());
        	registrationStmt.setDate(19,student.getJoinedDate());
        	registrationStmt.setInt(20,student.getStudentId());
          	registrationStmt.executeUpdate();
    	  }catch(Exception e){
    ...
    public ArrayList<StudentRegistration> getStudentDetails(int studentId){
       ...
       try{
		...
		studentDetails.setAge(registrationRs.getInt("age"));
